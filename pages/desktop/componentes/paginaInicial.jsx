            ...
            <div className="container-paginainicial">
                <div className="col" style={{alignItems: 'center'}}>
                    <div className="row" style={{width: 800, justifyContent: 'space-between', marginBottom: 30, alignItems: 'center'}}>
                        ...
                        <div className="row">
                            <span style={{ marginLeft: 60, marginTop: 30 }} className="container-paginas-texto">Construimos sua ideia de ponta a ponta utilizando as melhores tecnologias do mercado e com um design moderno e elegante.<br /><br />
